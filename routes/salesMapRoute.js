...
const router = require('express').Router(); // express 모듈에서 제공하는 Router 클래스 사용
const salesMapRoute = require('../controllers/salesMapCtrl'); // salesMapCtrl.js 파일을 salesMapRoute 변수로 가져오기
